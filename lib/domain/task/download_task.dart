...
class DownloadTask {
  ...
  DownloadTask.all({this.fileId, this.userId, this.targetPath, this.targetName, this.downloadUrl, this.totalSize, this.downloadedSize = 0, this.statusMessage, this.status, this.createTime});
}
